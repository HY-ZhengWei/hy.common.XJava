...
* XJava
	...
	* 注解
		* [@Xjava 依赖注入](src/main/java/org/hy/common/xml/annotation/Xjava.java)
		* [@Xsql 映射SQL配置文件，无须持久层实体类](src/main/java/org/hy/common/xml/annotation/Xsql.java)
		* [@Xparam 方法参数映射SQL占位符及非空检查](src/main/java/org/hy/common/xml/annotation/Xparam.java)
		* [@XRequest 定义请求接口](src/main/java/org/hy/common/xml/annotation/XRequest.java)
		* [@Doc 将注释保留在编译后的二进制程序中](src/main/java/org/hy/common/xml/annotation/Doc.java)
* [XSQL 轻量级持久层](#轻量级持久层xsql)
* [XSQLGroup 轻量级ETL](#轻量级etl)
* [XSQLPaging 多种类数据库通用分页](src/main/java/org/hy/common/xml/XSQLPaging.xml)
* [XJSON Json与Java对象的转换](src/main/java/org/hy/common/xml/XJSON.java)
* [XHttp Http访问](src/main/java/org/hy/common/xml/XHttp.java)
* [XWebService 接口服务](src/main/java/org/hy/common/xml/XWebService.java)
* [特别鸣谢](#特别鸣谢)

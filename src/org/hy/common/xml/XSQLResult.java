...
public final class XSQLResult 
{
	...
	/**
     * 一对多关系时，识别出属于同一对象的主键信息（多个属性间用逗号分隔） ZhengWei(HY) Add 2017-03-01
     * 此为可选项
     */
	...
	public void setCfill(String i_CFill) 
	{
		...
		{
			if ( i_CFill.trim().toUpperCase().startsWith("SETTER(") )
			{
    ...
    /**
     * 获取：一对多关系时，识别出属于同一对象的主键信息（多个属性间用逗号分隔） ZhengWei(HY) Add 2017-03-01
     * 此为可选项
     */
    ...
    /**
     * 设置：一对多关系时，识别出属于同一对象的主键信息（多个属性间用逗号分隔） ZhengWei(HY) Add 2017-03-01
     * 此为可选项
     * 

var DateHelp = {
    ...
    calcSolarTerm: function(i_Year ,i_Month)
    {
        ...
        /* 小寒：例外：1982年计算结果加1日，2019年减1日。 */
        if ( i_Month == 1 )
        {
            if  ( i_Year == 1982 )
            {
                v_Ret[0].day = v_Ret[0].day + 1;
            }
            else if ( i_Year == 2019 )
            {
                v_Ret[0].day = v_Ret[0].day - 1;
        ...
        /* 大寒：例外：2082年的计算结果加1日，20世纪无。*/
        else if ( i_Year == 2082 && i_Month == 1 )
        {
            v_Ret[1].day = v_Ret[1].day + 1;
        }
        /* 雨水：例外：2026年计算得出的雨水日期应调减一天为18日。*/
        else if ( i_Year == 2026 && i_Month == 2 )
        {
            v_Ret[1].day = v_Ret[1].day - 1;
        }
        /* 春分：例外：2084年的计算结果加1日。*/
        else if ( i_Year == 2084 && i_Month == 3 )
        {
            v_Ret[1].day = v_Ret[1].day + 1;
        }
        /* 立夏：例外：1911年的计算结果加1日。*/
        else if ( i_Year == 1911 && i_Month == 5 )
        {
            v_Ret[0].day = v_Ret[0].day + 1;
        }
        /* 小满：例外：2008年的计算结果加1日。*/
        else if ( i_Year == 2008 && i_Month == 5 )
        {
            v_Ret[1].day = v_Ret[1].day + 1;
        }
        /* 芒种：例外：1902年的计算结果加1日。*/
        if ( i_Year == 1902 && i_Month == 6 )
        {
            v_Ret[0].day = v_Ret[0].day + 1;
        }
        /* 夏至：例外：1928年的计算结果加1日。*/
        else if ( i_Year == 1928 && i_Month == 6 )
        {
            v_Ret[1].day = v_Ret[1].day + 1;
        }
        /* 小暑：例外：1925年和2016年的计算结果加1日。*/
        else if ( i_Year == 1925 || i_Year == 2016 )
        {
            if ( i_Month == 7 )
            {
                v_Ret[0].day = v_Ret[0].day - 1;
        ...
        /* 大暑：例外：1922年的计算结果加1日。*/
        else if ( i_Year == 1922 && i_Month == 7 )
        {
            v_Ret[1].day = v_Ret[1].day + 1;
        }
        /* 立秋：例外：2002年的计算结果加1日。*/
        else if ( i_Year == 2002 && i_Month == 8 )
        {
            v_Ret[0].day = v_Ret[0].day + 1;
        }
        /* 白露：例外：1927年的计算结果加1日。*/
        else if ( i_Year == 1927 && i_Month == 9 )
        {
            v_Ret[0].day = v_Ret[0].day + 1;
        }
        /* 秋分：例外：1942年的计算结果加1日。*/
        else if ( i_Year == 1942 && i_Month == 9 )
        {
            v_Ret[1].day = v_Ret[1].day + 1;
        }
        /* 霜降：例外：2089年的计算结果加1日。*/
        else if ( i_Year == 2089 && i_Month == 10 )
        {
            v_Ret[1].day = v_Ret[1].day + 1;
        }
        /* 立冬：例外：2089年的计算结果加1日。*/
        else if ( i_Year == 2089 && i_Month == 11 )
        {
            v_Ret[0].day = v_Ret[0].day + 1;
        }
        /* 小雪：例外：1978年的计算结果加1日。*/
        else if ( i_Year == 1978 && i_Month == 11 )
        {
            v_Ret[1].day = v_Ret[1].day + 1;
        }
        /* 大雪：例外：1954年的计算结果加1日。*/
        else if ( i_Year == 1954 && i_Month == 12 )
        {
            v_Ret[0].day = v_Ret[0].day + 1;
        }
        /* 冬至：例外：1918年和2021年的计算结果减1日*/
        else if ( i_Year == 1981 || i_Year == 2021 )
        {
            if ( i_Month == 12 )
            {
                v_Ret[1].day = v_Ret[1].day - 1;

...
public final class XSQLMethodParam_Fill
{
     ...
     * @return
     */
    public static XSQLMethodParam getInstance(int i_ParamType ,Method i_ObjGetter ,String i_MapKey)
    {
        if ( i_ParamType == $FILL_ROW )
        {
            return $FILL_PARAM_ROW;
        ...
        else if ( i_ParamType == $FILL_ROW_MapGet )
        {
            if ( i_ObjGetter != null )
            {
                return new XSQLMethodParam_Fill_Row_MapGet(i_ObjGetter ,i_MapKey);
            }
            else
            {
 ...
 */
class XSQLMethodParam_Fill_Row_MapGet implements XSQLMethodParam
{
    ...
    public XSQLMethodParam_Fill_Row_MapGet(Method i_ObjGetter ,String i_MapKey)
    {
        this.paramType = XSQLMethodParam_Fill.$FILL_ROW_MapGet;

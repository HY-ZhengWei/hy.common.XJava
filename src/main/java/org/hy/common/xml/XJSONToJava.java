 ...
 *           V2.0  2022-06-22 添加：支持特殊类型ExpireMap  的转Java
 *           V3.0  2026-02-11 添加：支持特殊类型ExpireCache的转Java
 */
public class XJSONToJava
{
     ...
     */
    @SuppressWarnings("unchecked")
    public static void mapValueToJava(XJSON i_XJson ,ExpireCache<String ,Object> i_Map ,String i_MapKey ,Object i_MapValue)
    {
        Map<String ,Object> v_MapValue = (Map<String ,Object>)i_MapValue;
        i_Map.putMilli(i_MapKey ,v_MapValue.get("value") ,(Date)v_MapValue.get("createTime") ,(Long)v_MapValue.get("time"));
    }
